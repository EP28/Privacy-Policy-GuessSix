...
We **do not collect any personal information**, such as names, emails, or phone numbers. We also **do not collect device information** (e.g., IP addresses, device IDs) or location data. Users do not create accounts to use GuessSix.
...
Since we **do not collect personal information**, there is minimal data at risk. We maintain standard security measures to ensure safe operation of the app.

## 7. Children’s Privacy

GuessSix is **not intended for children under 18**.

## 8. User Rights

As we **do not collect personal data**, users cannot request deletion of data.
